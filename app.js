...
const TEAM_LOGOS = {
  ...
  "SAS": { svg: `<svg viewBox='0 0 32 32' xmlns='http://www.w3.org/2000/svg' style='width:100%;height:100%;image-rendering:pixelated'><rect width='32' height='32' fill='#020c18'/><!-- Spur rowel - 6 pointed star --><rect x='14' y='4' width='4' height='4' fill='#c0c0c0'/><rect x='4' y='14' width='4' height='4' fill='#c0c0c0'/><rect x='24' y='14' width='4' height='4' fill='#c0c0c0'/><rect x='14' y='24' width='4' height='4' fill='#c0c0c0'/><rect x='7' y='7' width='4' height='4' fill='#c0c0c0'/><rect x='21' y='7' width='4' height='4' fill='#c0c0c0'/><rect x='7' y='21' width='4' height='4' fill='#c0c0c0'/><rect x='21' y='21' width='4' height='4' fill='#c0c0c0'/><!-- center --><rect x='12' y='12' width='8' height='8' fill='#c0c0c0'/><rect x='13' y='13' width='6' height='6' fill='#020c18'/><rect x='14' y='14' width='4' height='4' fill='#888'/></svg>`, color: "#c0c0c0" },
  ...
  "HOU": { svg: `<svg viewBox='0 0 32 32' xmlns='http://www.w3.org/2000/svg' style='width:100%;height:100%;image-rendering:pixelated'><rect width='32' height='32' fill='#020c18'/><!-- Rocket body --><rect x='14' y='4' width='4' height='2' fill='#fff'/><rect x='12' y='6' width='8' height='2' fill='#ce1141'/><rect x='12' y='8' width='8' height='2' fill='#ce1141'/><rect x='12' y='10' width='8' height='2' fill='#fff'/><rect x='12' y='12' width='8' height='2' fill='#ce1141'/><rect x='12' y='14' width='8' height='2' fill='#ce1141'/><rect x='12' y='16' width='8' height='2' fill='#ce1141'/><!-- fins --><rect x='8' y='16' width='4' height='6' fill='#ce1141'/><rect x='20' y='16' width='4' height='6' fill='#ce1141'/><rect x='6' y='20' width='4' height='4' fill='#ce1141'/><rect x='22' y='20' width='4' height='4' fill='#ce1141'/><!-- exhaust flame --><rect x='12' y='22' width='8' height='2' fill='#fdb927'/><rect x='13' y='24' width='6' height='2' fill='#ff6600'/><rect x='14' y='26' width='4' height='2' fill='#ff3300'/><rect x='15' y='28' width='2' height='2' fill='#ff1100' opacity='.6'/><!-- window --><rect x='14' y='10' width='4' height='4' fill='#88ccff'/><rect x='15' y='11' width='2' height='2' fill='#fff' opacity='.6'/></svg>`, color: "#ce1141" },
  "MIN": { svg: `<svg viewBox='0 0 32 32' xmlns='http://www.w3.org/2000/svg' style='width:100%;height:100%;image-rendering:pixelated'><rect width='32' height='32' fill='#020c18'/><!-- Wolf head --><!-- ears --><rect x='6' y='4' width='6' height='8' fill='#236192'/><rect x='20' y='4' width='6' height='8' fill='#236192'/><rect x='8' y='6' width='2' height='4' fill='#78232a'/><rect x='22' y='6' width='2' height='4' fill='#78232a'/><!-- head --><rect x='8' y='10' width='16' height='12' fill='#236192'/><!-- snout --><rect x='10' y='18' width='12' height='6' fill='#78232a'/><rect x='12' y='22' width='8' height='4' fill='#236192' opacity='.6'/><!-- eyes --><rect x='10' y='12' width='4' height='4' fill='#fff'/><rect x='18' y='12' width='4' height='4' fill='#fff'/><rect x='11' y='13' width='2' height='2' fill='#236192'/><rect x='19' y='13' width='2' height='2' fill='#236192'/><!-- eye shine --><rect x='11' y='13' width='1' height='1' fill='#78d6ff'/><rect x='19' y='13' width='1' height='1' fill='#78d6ff'/><!-- nose --><rect x='14' y='20' width='4' height='2' fill='#020c18'/></svg>`, color: "#236192" },
  "POR": { svg: `<svg viewBox='0 0 32 32' xmlns='http://www.w3.org/2000/svg' style='width:100%;height:100%;image-rendering:pixelated'><rect width='32' height='32' fill='#020c18'/><!-- Pine tree --><!-- trunk --><rect x='14' y='24' width='4' height='6' fill='#8B4513'/><!-- layers of branches --><rect x='14' y='18' width='4' height='2' fill='#e03a3e'/><rect x='12' y='20' width='8' height='2' fill='#e03a3e'/><rect x='12' y='14' width='8' height='2' fill='#e03a3e'/><rect x='10' y='16' width='12' height='2' fill='#e03a3e'/><rect x='12' y='10' width='8' height='2' fill='#e03a3e'/><rect x='10' y='12' width='12' height='2' fill='#e03a3e'/><rect x='14' y='6' width='4' height='2' fill='#e03a3e'/><rect x='12' y='8' width='8' height='2' fill='#e03a3e'/><rect x='10' y='14' width='2' height='2' fill='#e03a3e'/><rect x='20' y='14' width='2' height='2' fill='#e03a3e'/><rect x='8' y='18' width='2' height='2' fill='#e03a3e'/><rect x='22' y='18' width='2' height='2' fill='#e03a3e'/><!-- snow on tips --><rect x='14' y='6' width='4' height='2' fill='#fff' opacity='.8'/><rect x='10' y='12' width='4' height='2' fill='#fff' opacity='.4'/><rect x='20' y='12' width='2' height='2' fill='#fff' opacity='.4'/></svg>`, color: "#e03a3e" },
  ...
  "DET": { svg: `<svg viewBox='0 0 32 32' xmlns='http://www.w3.org/2000/svg' style='width:100%;height:100%;image-rendering:pixelated'><rect width='32' height='32' fill='#020c18'/><!-- Piston / engine cylinder --><!-- cylinder body --><rect x='8' y='8' width='16' height='14' fill='#006bb6'/><rect x='10' y='10' width='12' height='10' fill='#020c18'/><rect x='10' y='10' width='12' height='10' fill='#006bb6' opacity='.2'/><!-- piston rod --><rect x='14' y='6' width='4' height='16' fill='#c0c0c0'/><rect x='12' y='20' width='8' height='4' fill='#c0c0c0'/><!-- piston head --><rect x='10' y='4' width='12' height='4' fill='#006bb6'/><rect x='11' y='5' width='10' height='2' fill='#4ab4e6' opacity='.5'/><!-- bolts on cylinder --><rect x='8' y='8' width='3' height='3' fill='#888'/><rect x='21' y='8' width='3' height='3' fill='#888'/><rect x='8' y='19' width='3' height='3' fill='#888'/><rect x='21' y='19' width='3' height='3' fill='#888'/><!-- exhaust lines --><rect x='4' y='12' width='4' height='2' fill='#c0c0c0' opacity='.6'/><rect x='24' y='12' width='4' height='2' fill='#c0c0c0' opacity='.6'/><rect x='4' y='16' width='3' height='2' fill='#c0c0c0' opacity='.4'/><rect x='25' y='16' width='3' height='2' fill='#c0c0c0' opacity='.4'/></svg>`, color: "#006bb6" },
  "BOS": { svg: `<svg viewBox='0 0 32 32' xmlns='http://www.w3.org/2000/svg' style='width:100%;height:100%;image-rendering:pixelated'><rect width='32' height='32' fill='#020c18'/><!-- Shamrock --><!-- stem --><rect x='15' y='22' width='2' height='8' fill='#007a33'/><rect x='13' y='26' width='6' height='2' fill='#007a33'/><!-- top leaf --><rect x='12' y='8' width='8' height='8' fill='#007a33'/><rect x='10' y='10' width='12' height='4' fill='#007a33'/><rect x='14' y='6' width='4' height='4' fill='#007a33'/><!-- left leaf --><rect x='4' y='14' width='8' height='8' fill='#007a33'/><rect x='6' y='12' width='4' height='12' fill='#007a33'/><rect x='2' y='16' width='4' height='4' fill='#007a33'/><!-- right leaf --><rect x='20' y='14' width='8' height='8' fill='#007a33'/><rect x='22' y='12' width='4' height='12' fill='#007a33'/><rect x='26' y='16' width='4' height='4' fill='#007a33'/><!-- leaf shine --><rect x='14' y='8' width='2' height='2' fill='#00cc55' opacity='.5'/><rect x='6' y='16' width='2' height='2' fill='#00cc55' opacity='.5'/><rect x='24' y='16' width='2' height='2' fill='#00cc55' opacity='.5'/></svg>`, color: "#007a33" },
  "NYK": { svg: `<svg viewBox='0 0 32 32' xmlns='http://www.w3.org/2000/svg' style='width:100%;height:100%;image-rendering:pixelated'><rect width='32' height='32' fill='#020c18'/><!-- NYC skyline silhouette --><!-- buildings --><rect x='2' y='18' width='4' height='12' fill='#f58426'/><rect x='6' y='14' width='3' height='16' fill='#f58426'/><rect x='9' y='20' width='3' height='10' fill='#f58426'/><rect x='12' y='10' width='4' height='20' fill='#f58426'/><!-- Empire State Building --><rect x='14' y='6' width='2' height='4' fill='#f58426'/><rect x='15' y='4' width='1' height='4' fill='#f58426'/><rect x='16' y='10' width='2' height='20' fill='#f58426'/><rect x='18' y='8' width='3' height='22' fill='#f58426'/><rect x='21' y='14' width='3' height='16' fill='#f58426'/><rect x='24' y='18' width='4' height='12' fill='#f58426'/><rect x='27' y='22' width='3' height='8' fill='#f58426'/><!-- windows --><rect x='7' y='16' width='1' height='1' fill='#020c18'/><rect x='13' y='12' width='1' height='1' fill='#020c18'/><rect x='17' y='10' width='1' height='1' fill='#020c18'/><rect x='19' y='10' width='1' height='1' fill='#020c18'/><rect x='22' y='16' width='1' height='1' fill='#020c18'/></svg>`, color: "#f58426" },
  "CLE": { svg: `<svg viewBox='0 0 32 32' xmlns='http://www.w3.org/2000/svg' style='width:100%;height:100%;image-rendering:pixelated'><rect width='32' height='32' fill='#020c18'/><!-- Sword --><!-- blade --><rect x='15' y='4' width='2' height='18' fill='#c0c0c0'/><rect x='14' y='4' width='4' height='2' fill='#c0c0c0'/><rect x='13' y='6' width='2' height='2' fill='#aaa'/><rect x='17' y='6' width='2' height='2' fill='#aaa'/><!-- crossguard --><rect x='8' y='20' width='16' height='3' fill='#860038'/><rect x='6' y='21' width='4' height='4' fill='#860038'/><rect x='22' y='21' width='4' height='4' fill='#860038'/><!-- handle --><rect x='14' y='22' width='4' height='8' fill='#8B4513'/><rect x='13' y='24' width='6' height='4' fill='#8B4513'/><!-- pommel --><rect x='13' y='28' width='6' height='3' fill='#860038'/><!-- blade shine --><rect x='15' y='6' width='1' height='14' fill='#fff' opacity='.4'/><!-- gem in crossguard --><rect x='15' y='20' width='2' height='3' fill='#ffd700'/></svg>`, color: "#860038" },
  "TOR": { svg: `<svg viewBox='0 0 32 32' xmlns='http://www.w3.org/2000/svg' style='width:100%;height:100%;image-rendering:pixelated'><rect width='32' height='32' fill='#020c18'/><!-- Raptor claw / talon --><!-- main claw --><rect x='14' y='4' width='4' height='14' fill='#ce1141'/><rect x='12' y='6' width='2' height='2' fill='#ce1141'/><rect x='18' y='6' width='2' height='2' fill='#ce1141'/><!-- claw tip curve --><rect x='12' y='16' width='4' height='4' fill='#ce1141'/><rect x='10' y='18' width='4' height='4' fill='#ce1141'/><rect x='8' y='22' width='4' height='4' fill='#ce1141'/><rect x='6' y='24' width='4' height='4' fill='#ce1141'/><!-- second claw --><rect x='18' y='14' width='4' height='4' fill='#ce1141'/><rect x='20' y='18' width='4' height='4' fill='#ce1141'/><rect x='22' y='22' width='4' height='4' fill='#ce1141'/><!-- third claw --><rect x='16' y='14' width='2' height='16' fill='#ce1141'/><rect x='16' y='28' width='4' height='2' fill='#ce1141'/><!-- shine --><rect x='15' y='5' width='1' height='8' fill='#ff6688' opacity='.4'/></svg>`, color: "#ce1141" },
  "ATL": { svg: `<svg viewBox='0 0 32 32' xmlns='http://www.w3.org/2000/svg' style='width:100%;height:100%;image-rendering:pixelated'><rect width='32' height='32' fill='#020c18'/><!-- Hawk in flight --><!-- body --><rect x='13' y='12' width='6' height='8' fill='#e03a3e'/><!-- head --><rect x='18' y='8' width='6' height='6' fill='#e03a3e'/><rect x='22' y='10' width='4' height='2' fill='#e03a3e'/><!-- beak --><rect x='26' y='10' width='4' height='2' fill='#fdb927'/><!-- eye --><rect x='22' y='9' width='2' height='2' fill='#fff'/><rect x='23' y='9' width='1' height='1' fill='#020c18'/><!-- left wing spread wide --><rect x='2' y='12' width='12' height='4' fill='#e03a3e'/><rect x='2' y='14' width='4' height='6' fill='#e03a3e'/><rect x='4' y='16' width='4' height='4' fill='#e03a3e'/><rect x='6' y='18' width='4' height='4' fill='#cc2030'/><!-- right wing --><rect x='18' y='12' width='10' height='4' fill='#e03a3e'/><rect x='22' y='14' width='6' height='4' fill='#e03a3e'/><rect x='24' y='18' width='4' height='4' fill='#cc2030'/><!-- tail --><rect x='10' y='18' width='8' height='4' fill='#e03a3e'/><rect x='11' y='22' width='6' height='4' fill='#e03a3e'/><rect x='12' y='24' width='4' height='4' fill='#cc2030'/></svg>`, color: "#e03a3e" },
  "PHI": { svg: `<svg viewBox='0 0 32 32' xmlns='http://www.w3.org/2000/svg' style='width:100%;height:100%;image-rendering:pixelated'><rect width='32' height='32' fill='#020c18'/><!-- Liberty Bell --><!-- bell dome --><rect x='10' y='6' width='12' height='2' fill='#c8a96e'/><rect x='8' y='8' width='16' height='2' fill='#c8a96e'/><rect x='6' y='10' width='20' height='2' fill='#c8a96e'/><rect x='6' y='12' width='20' height='2' fill='#c8a96e'/><rect x='6' y='14' width='20' height='2' fill='#c8a96e'/><rect x='6' y='16' width='20' height='2' fill='#c8a96e'/><rect x='8' y='18' width='16' height='2' fill='#c8a96e'/><!-- bell flare bottom --><rect x='6' y='20' width='20' height='3' fill='#c8a96e'/><rect x='4' y='22' width='24' height='2' fill='#c8a96e'/><!-- crack - Liberty Bell's famous crack --><rect x='14' y='10' width='2' height='12' fill='#020c18' opacity='.8'/><rect x='15' y='12' width='2' height='8' fill='#020c18' opacity='.6'/><!-- clapper --><rect x='15' y='24' width='2' height='4' fill='#a08040'/><rect x='14' y='27' width='4' height='2' fill='#a08040'/><!-- hanger --><rect x='13' y='4' width='6' height='4' fill='#c8a96e'/><rect x='14' y='2' width='4' height='4' fill='#020c18'/><rect x='15' y='2' width='2' height='4' fill='#c8a96e'/></svg>`, color: "#006bb6" },
  "ORL": { svg: `<svg viewBox='0 0 32 32' xmlns='http://www.w3.org/2000/svg' style='width:100%;height:100%;image-rendering:pixelated'><rect width='32' height='32' fill='#020c18'/><!-- Magic wand with star burst --><!-- wand handle --><rect x='20' y='20' width='3' height='10' fill='#c8a96e' style='transform:rotate(45deg)'/><rect x='18' y='22' width='12' height='3' fill='#020c18'/><rect x='20' y='20' width='10' height='2' fill='#c8a96e'/><rect x='22' y='22' width='8' height='2' fill='#c8a96e'/><rect x='24' y='24' width='6' height='2' fill='#c8a96e'/><rect x='26' y='26' width='4' height='2' fill='#c8a96e'/><!-- star burst at wand tip --><rect x='14' y='14' width='4' height='4' fill='#ffd700'/><rect x='12' y='16' width='8' height='2' fill='#ffd700'/><rect x='15' y='12' width='2' height='8' fill='#ffd700'/><rect x='11' y='13' width='3' height='3' fill='#ffd700'/><rect x='18' y='13' width='3' height='3' fill='#ffd700'/><rect x='11' y='18' width='3' height='3' fill='#ffd700'/><rect x='18' y='18' width='3' height='3' fill='#ffd700'/><!-- sparkles --><rect x='4' y='6' width='2' height='2' fill='#0077c0' opacity='.8'/><rect x='8' y='4' width='2' height='2' fill='#ffd700' opacity='.7'/><rect x='6' y='10' width='2' height='2' fill='#0077c0' opacity='.6'/><rect x='24' y='6' width='2' height='2' fill='#ffd700' opacity='.7'/><rect x='4' y='22' width='2' height='2' fill='#ffd700' opacity='.5'/></svg>`, color: "#0077c0" },
...
function playerPortraitHtml(name, team, size=36){ return playerLogoHtml(team, size); }
